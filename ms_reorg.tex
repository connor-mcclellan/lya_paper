...
{\color{red} Moved text on Harrington into the introduction since it is a primary driver of the calculation.}
...
{\color{red} Moved the time dependent part back to the appendix. It is probably sufficient to just state eq. \ref{eq:finaleqn} as the starting point, referring to the reader to the appendix. We may want a short paragraph defining some of the key notation, though, so the reader is not forced to extensively reference the appendix.}
...
{\color{red} We do not need an extensive discussion fo the divergent solution, but we should probably right it down here for compelteness, since we include it in the figure.}
...
{\color{red} This section can probably be shortened to a couple of paragraphs with most of the equations removed and the results just stated.}
...
{\color{red} Moved the acceleration content to discussion}
