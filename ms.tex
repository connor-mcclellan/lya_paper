...
\correspondingauthor{Connor McClellan}
...
\proposed{
The outer layers of planetary atmospheres are central to a planet's evolution, as they can shelter the lower atmosphere from high energy radiation and regulate the escape of gas into space.} % Add something about lyman alpha here
...
\todo{There exist several fundamental questions about the evolution and stability of exoplanet atmospheres that have become irradiated by their host stars; understanding which physical and chemical processes are important in these regions can assist in the creation of robust models to answer such questions. (TODO: This sentence reads mostly like fluff but I'm not sure how to outline the problem otherwise.)}
...
% Put emphasis on the fact that Lya is generated within the atmosphere --- ionization and rate equilibrium balanced by recombination. Recombination gives you lyman alpha again. Collisions decrease the density in the 2s states. The efficiency of producing lya is quite high, and that's immediately at high optical depth.
