...
Hubble Space Telescope (HST) observations with STIS have found large Lyman $\alpha$ transit depths, indicating an extended distribution of hydrogen around a handful of exoplanets \todo{Organize these by date?} (\citealp{2003Natur.422..143V}; \citealp{2012A&A...543L...4L}; \citealp{2012A&A...547A..18E}; \citealp{2015Natur.522..459E}; \citealp{2018A&A...620A.147B}; \citealp{2019EPSC...13.1928L}; \citealp{2021arXiv210309864B}; \citealp{2012A&A...547A..18E}; \citealp{2017A&A...597A..26B}; \citealp{2019AJ....158...50W}; \citealp{2020ApJ...888L..21G}; \citealp{2017A&A...599L...3B}; \citealp{2017A&A...602A.106B}). These observations have revealed a population of atoms extending out to distances of order the planetary radius for several planets around bright, nearby stars, motivating a study of the physics of \lya interactions with H atoms surrounding a planet. The importance of the \lya line in the atmospheric dynamics of these systems necessitates a careful treatment of resonant scattering in order to construct accurate models of atmospheric heating and escape. However, the extreme optical depths at \lya line center introduce a computational barrier to simulating radiative transfer via Monte Carlo methods.
