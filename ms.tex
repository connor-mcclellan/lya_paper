...
\ee
Thus, the fractional importance of the correct frequency-dependent boundary condition term $H_{\rm bc}$ scales as $(a\tau_0)^{-1/3}$. At large $\tau_0$, it is expected that the correction term will be small, but will become increasingly important as $\tau_0$ decreases.
