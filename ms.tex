...
Rewriting Eq. C17 from \citet{2006ApJ...649...14D} in our notation, a comparison can be made with the surface flux derived from their closed-form solution, Eq. \ref{eq:H0surf}. Under the two-stream approximation, it is expected that the boundary condition in Eq. \ref{eq:bc} hold true if the solutions are consistent. 
