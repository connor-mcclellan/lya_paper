...
\ee
Summing over all spatial modes $n$ and over all eigenmodes $m$ for a given $n$, we get the final form of the result:
\be \label{eq:Jrsigmat}
J(r,\sigma,t) & = & \sum_{n=1}^\infty j_0(\kappa_n r)  \sum_m^{\infty} J_{nm}(\sigma) e^{-\gamma_{nm}t}.
\ee
