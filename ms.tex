...
\begin{figure}
    ...
    \caption{Eigenfunctions $J_{nm}(x)$ for the lowest-order spatial eigenmode $n=1$, and $m=1, ..., 100$ with $x_s=0$ and $\tau_0=10^7$. \textbf{The scale of the $J_{nm}(\sigma)$ are set by the factor $E/(kR^3)$, which here is ${\sim}10^{-37}$ in ergs/(cm$^2$ Hz).}}
    \label{fig:jsoln}
\end{figure}
