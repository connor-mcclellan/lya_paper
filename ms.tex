...
\begin{figure}
    ...
    \caption{Eigenfunctions $J_{nm}(x)$ for the lowest-order spatial eigenmode $n=1$, and $m=1, ..., 100$ with $a = 4.72\times 10^{-4}$ and $\tau_0=10^7$.}
    \label{fig:jsoln}
\end{figure}
...
\begin{figure}
    ...
    \caption{Comparison of steady-state and time-integrated spectra for $n=1, ..., 20$ and $m=1, ..., 500$ for $\tau_0=10^7$.}
