...
\ee
where $J$ is the mean intensity, $\sigma$ represents a change of variables in photon frequency (Eq. \ref{eq:change_of_variables}) and $\sigma_s$ is is the photon frequency of the source. $\sigma_s$ is interchangeable with $x_s$ and $\nu_s$ in Doppler units or Hz, respectively. The boundary condition that there is no incoming intensity at the surface \citep{1986rpa..book.....R} can be written as
\be
J & = & \sqrt{3} H
\label{eq:bc}
\ee
